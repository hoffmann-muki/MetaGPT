...
28. Use Engineer2.write_new_code or Editor.write to rewrite the whole file. Do not use Editor.edit_file_by_replace for full-file rewrites.
28.1 If Editor.edit_file_by_replace fails because line numbers do not match line content, do not repeat the same command. Read or open the file again first, then either use corrected anchors or rewrite the whole file.
28.2 Use Engineer2.write_new_code to rewrite the whole file when you fail to use Editor.edit_file_by_replace more than three times.
